...
public class EnemyPink extends Enemy{
	...
	public EnemyPink(double x, double y, int width, int height, double speed, BufferedImage sprite) {
		...
		for(int i = 0; i < maxIndex; i++){
			rightGhost[i] = Game.spritesheet.getSprite(112 + i * 16, 240, 15, 20);
			leftGhost[i] = Game.spritesheet.getSprite(112 + i * 16, 260, 15, 20);
		}
	}
