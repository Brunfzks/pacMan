...
public class EnemyRed extends Enemy{
	...
	public EnemyRed(double x, double y, int width, int height, double speed, BufferedImage sprite) {
		...
		for(int i = 0; i < maxIndex; i++){
			rightGhost[i] = Game.spritesheet.getSprite(336 + i * 16, 240, 15, 20);
			leftGhost[i] = Game.spritesheet.getSprite(336 + i * 16, 260, 15, 20);
		}
	}
